...
class _AddLoanScreenState extends State<AddLoanScreen> {
                            ...
                            IntrinsicWidth(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  hintText: '0',
                                  hintStyle: TextStyle(
                                    color: Color(0xFFcbd5e1), // Matches light mode placeholder
                                  ),
                                  isDense: true,
                                    ...
                                    children: [
                                      TextField(
                                        ...
                                        decoration: _getInputDecoration(
                                          hint: '0.0',
                                          isDark: isDark,
                                        ).copyWith(contentPadding: const EdgeInsets.fromLTRB(14, 14, 30, 14)),
                                      ),
                                      const Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              _tenureType = _tenureType == 'Yrs' ? 'Mos' : 'Yrs';
                                            });
                                          },
                                          child: Padding(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold,
                                          letterSpacing: 0.5,
                                          color: Color(0xFF166534), // primary-dark
                                        ),
                                      ),
                                      SizedBox(height: 2),
                                      Text(
  ...
  Widget _buildTypeButton(String title, bool isSelected, VoidCallback onTap, bool isDark) {
  ...
  InputDecoration _getInputDecoration({required String hint, required bool isDark}) {
